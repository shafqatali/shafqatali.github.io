...
function fetchPlaceData(wrapperId, placeToFind) {
    ...
    if (place.length) {
        ...
        if(fileCount > 1){
            reset360Viewer();
            var markup360 = '<div id="panzoom" class="threesixty" data-path="ROOT_PATH/{index}.jpg" data-count="ITEM_COUNT"><div class="ui-spinner"><span class="side side-left"><span class="fill"></span></span><span class="side side-right"><span class="fill"></span></span></div></div>';
