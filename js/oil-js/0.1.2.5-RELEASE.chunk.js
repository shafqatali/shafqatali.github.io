...
(window.oilJsonp = window.oilJsonp || []).push([[0], {
    103: function (t, e, i) {
        ...
        Object.defineProperty(e, "renderOil", {
            ...
            var e, i = this, o = (0, r.getLocale)(), a = o && o.texts ? (e = o.texts, Object.values(n.OIL_LABELS).filter(function (t) {
        ...
        var o = i(2), a = i(16), n = i(13), l = i(136), s = i(101), r = i(138), c = i(140), p = v(i(133)), d = v(i(143)), _ = i(5), u = i(127), f = i(6), h = i(146), b = i(147), m = i(29), g = i(102);
        ...
        function S() {
            return {oilWrapper: document.querySelectorAll(".as-oil"), btnOptIn: document.querySelectorAll("." + n.JS_CLASS_BUTTON_OPTIN), btnPoiOptIn: document.querySelectorAll(".as-js-optin-poi"), companyList: document.querySelectorAll(".as-js-companyList"), thirdPartyList: document.querySelectorAll(".as-js-thirdPartyList"), btnAdvancedSettings: document.querySelectorAll("." + n.JS_CLASS_BUTTON_ADVANCED_SETTINGS), btnBack: document.querySelectorAll("." + n.JS_CLASS_BUTTON_OILBACK)}
        }
        ...
        Object.defineProperty(e, "__esModule", {value: !0}), e.activatePowerOptInWithIFrame = function (t) {
            ...
            if ((0, a.isPoiActive)()) {
                var i = JSON.stringify(t), n = encodeURIComponent(i), l = (0, a.getHubLocation)(), s = (0, a.getPoiGroupName)();
                if (l) {
        ...
        Object.defineProperty(e, "__esModule", {value: !0}), e.oilAdvancedSettingsInlineTemplate = _, e.oilAdvancedSettingsTemplate = function () {
            ...
            (0, a.forEach)(document.querySelectorAll(".as-js-purpose-slider"), function (t) {
                t && t.addEventListener("change", function (t) {
                    return function (t) {
                        var e = t.getAttribute("data-id"), i = document.getElementById("purpose-feature-texts-" + e).getElementsByClassName("checkmark");
        ...
        t.exports = {
            localeId: "enEN_00", version: 0, texts: {
